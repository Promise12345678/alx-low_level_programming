...
/**
 * f4 - serves to find the biggest number
 *
 * @usrn: serves as username
 * @len: serves as length of username
...
/**
 * f5 - serves to multiply each char of username
 *
 * @usrn: username
...
/**
 * f6 - serves to generate a random char
 *
 * @usrn: username
